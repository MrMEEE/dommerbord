...
<div id="main">
   ...
   <br>
      ...
      $refstats=array();
      $tablestats=array();
      $refquery1 = mysql_query("SELECT refereeteam1id, COUNT( * ) as count FROM games WHERE date >= $fromdate GROUP BY refereeteam1id");
      $refquery2 = mysql_query("SELECT refereeteam2id, COUNT( * ) as count FROM games WHERE date >= $fromdate GROUP BY refereeteam2id");
      $tablequery1 = mysql_query("SELECT tableteam1id, COUNT( * ) as count FROM games WHERE date >= $fromdate GROUP BY tableteam1id");
      $tablequery2 = mysql_query("SELECT tableteam2id, COUNT( * ) as count FROM games WHERE date >= $fromdate GROUP BY tableteam2id");
      $tablequery3 =mysql_query("SELECT tableteam3id, COUNT( * ) as count FROM games WHERE date >= $fromdate GROUP BY tableteam3id");
